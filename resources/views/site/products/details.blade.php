    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> <a href="shop-grid-right.html">{{ $product['category']['name'] }}</a> <span></span>
                {{ $product['subcategory']['name'] }} <span></span>{{ $product->product_name }}
            </div>
        </div>
    </div>
                                ...
                                <div class="font-xs">
                                    <ul class="mr-50 float-start">
                                        <li class="mb-5">Brand: <span
                                                class="text-brand">{{ $product['brand']['name'] }}</span></li>

                                        <li class="mb-5">Category:<span class="text-brand">
                                                {{ $product['category']['name'] }}</span></li>

                                        <li>SubCategory: <span
                                                class="text-brand">{{ $product['subcategory']['name'] }}</span>
                                        </li>
                                    </ul>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="user justify-content-between d-flex">
                                                                    <div class="thumb text-center">
                                                                        ...
                                                                        <img src="{{ !empty($item->user->photo) && $item->user->photo != 'upload/no_image.jpg' ? url($item->user->photo) : url('upload/no_image.jpg') }}"
                                    ...
                                    <div class="comment-form">
                                        ...
                                        @guest
                                            <p> <b>For Add Product Review. You Need To Login First <a
                                                        href="{{ route('user.login.form') }}">Login Here </a> </b></p>
                                        @else
                                            <div class="row">
