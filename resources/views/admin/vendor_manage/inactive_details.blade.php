...
@section('title', 'InActive Vendor Details')
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="get" action="{{ route('admin.active.vendor', $inactiveVendorDetails->id) }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea name="vendor_short_info" class="form-control" id="inputAddress2" disabled placeholder="Vendor Info "
                                                rows="3">
					{{ $inactiveVendorDetails->vendor_short_info }}
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ !empty($inactiveVendorDetails->photo) && $inactiveVendorDetails->photo != 'upload/no_image.jpg' ? url('upload/vendor_images/' . $inactiveVendorDetails->photo) : url('upload/no_image.jpg') }}"
