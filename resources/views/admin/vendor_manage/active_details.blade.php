...
@section('title', 'Active Vendor Details')
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="get" action="{{ route('admin.inactive.vendor', $activeVendorDetails->id) }}"
					...
					{{ $activeVendorDetails->vendor_short_info }}
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ !empty($activeVendorDetails->photo) && $activeVendorDetails->photo != 'upload/no_image.jpg' ? url('upload/vendor_images/' . $activeVendorDetails->photo) : url('upload/no_image.jpg') }}"
